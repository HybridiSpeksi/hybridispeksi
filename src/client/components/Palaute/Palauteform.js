      ...
      <div className={'container-fluid ' + styles.container}>
        <div className={'row justify-content-center ' + styles.banner}>
          <div className={'col-sm-11 col-md-9 col-lg-6 ' + styles.form_canvas}>
            <h2>HybridiSpeksi 2019 - Viimenen lohikäärmeisku</h2>
            <h3>Produktion palautelomake</h3>
            <br />
            ...
            <form onSubmit={this.props.handleSubmit}>
              ...
              <div className={'row form-group align-items-center ' + styles.feedback}>
                ...
                <div className="col">
                  <textarea rows="4" name="feedback" id="feedbackInput" className="form-control" onChange={this.props.handleChange} value={this.props.feedback} />
                </div>
              </div>
