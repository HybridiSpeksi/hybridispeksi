  ...
  render() {
    return (
      <div className={'container-fluid ' + styles.container}>
        ...
        {/* 
          TÄSTÄ ALKAA LIPUNMYYNTIPALIKKA. SE EI TOIMI TÄLLÄ HETKELLÄ, SIIHEN PITÄÄ TEHDÄ KORJAUKSIA.
          AINAKIN DROPDOWN-VALIKKO ON RIKKI, SIIHEN UTILSIIN ON TULLUT MUUTOS VIIME VUODEN JÄLKEEN.
