    ...
    ajax.sendGet('/getOneVarausById/' + this.props.params._id)
      .then((_data) => {
        this.setState({
          ...
          ticketCount: _data.data.booking.ncount +
              _data.data.booking.scount +
              _data.data.booking.ocount,
        });
        console.log(_data);
      })
      .catch((err) => {
          ...
          <div className="col-11 col-sm-11 col-xl-5">
            ...
            <div className="row">
              ...
              <div className="col-sm-6 col-8">
                <p>{this.state.esitys.name} klo
                  <Moment format="HH.mm">{this.state.esitys.date}</Moment>
                </p>
              </div>
            </div>
            <div className="row">
