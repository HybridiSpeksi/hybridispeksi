      ...
      <div className={"container-fluid " + styles.container}>
        <div className={"row align-items-end " + styles.content_home}>
          <div className={"col-sm-6 " + styles.slogan}>
            <h1 className={"d-none d-md-block " + styles.slogan}>HybridiSpeksin rekrytilaisuus<br /><span className={styles.date}>26.9.</span><br />@ARC 1, Arcanum</h1>
            <h1 className="d-md-none">HybridiSpeksin rekrytilaisuus<br />26.9.<br />@ARC 1, Arcanum</h1>
          </div>
        </div>
