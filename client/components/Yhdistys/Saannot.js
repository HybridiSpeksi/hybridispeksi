      ...
      <div className={'container-fluid ' + styles.container}>
        ...
        <div className={'row justify-content-center ' + styles.content}>
          <div className={"col-11 col-sm-10 col-md-10 " + styles.saannotJaSeloste}>
            ...
            ja yhdistyksen jäsenten kesken.</p>
            ...
            avulla suunnitellaan ja toteutetaan teatteriproduktion, joka esitetään yhdistyksen ulkopuolisille henkilöille.</p>
            ...
            kiinnostunut. Yhdistys pitää yllä jäsenrekisteriä. Yhdistyksen varsinaiset jäsenet hyväksyy yhdistyksen hallitus.</p>
            ...
            laissa taikka yhdistyksen säännöissä mainittuja jäsenyyden ehtoja.</p>
            ...
            Hallituksen toimintasuunnitelman vahvistaa yhdistyksen kokous.</p>
            ...
            kun puheenjohtaja tai varapuheenjohtaja ja vähintään puolet (1/2) sen muista jäsenistä on paikalla.</p>
            ...
            ja määräysten noudattamista;</li>
            ...
            eron ja valitsee eronneen tilalle uuden edustajan.</p>
            ...
            myös muulle yhdistyksen jäsenelle.</p>
            ...
            hallitukselle yhden (1) viikon kuluessa asiakirjojen vastaanottamisesta.</p>
            ...
            aiheelliseksi. Ylimääräinen kokous on pidettävä yhden (1) kuukauden kuluessa kirjallisen pyynnön jättämisestä.</p>
            ...
            jäsentä. Kiireelliseksi asia voidaan julistaa 2/3 äänten enemmistöllä.</p>
            ...
            kokousta sähköpostitse yhdistyksen jäsenistön sähköpostilistalla taikka yhdistyksen internetsivustolla.</p>
            <p>Kokouskutsussa on mainittava, mikäli kokouksessa käsitellään yhdistyslain 23 §:ssä mainittuja tai 
            niihin verrattavia asioita, kuten:</p>
            <ol>
            ...
            huomattavan muun omaisuuden luovuttamista;</li>
            ...
            kokouskutsussa ja jos muutosta kannattaa vähintään 3/4 äänestyksessä annetuissa äänistä.</p>
            ...
            on saavutettava 3/4 äänten enemmistö annetuista äänistä käydäkseen kokouksen päätöksestä.</p>
            ...
            ja omaisuus Turun yliopistolle käytettäväksi luonnontieteiden ja tekniikan tiedekunnan hyväksi.</p>
            <h4>19§</h4>
